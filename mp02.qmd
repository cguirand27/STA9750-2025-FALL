...
format:
    html:
        theme: superhero  # Change this to any theme below
        code-fold: true
...
<h2 style="text-align: center; color: #2C3E50; margin-top: 0;">FEDERAL YIMBY INCENTIVE PROGRAM</h2>
<h3 style="text-align: center; color: #7F8C8D; margin-top: -10px;">Policy Brief for Congressional Sponsors</h3>
